...
class MyshopController extends Controller
{
    ...
    public function configureSave(Request $request)
    {
        ...
        $cfg['template_content'] = [
            'hero_badge'        => trim((string) $request->input('tc.hero_badge', 'Trusted Local Shop')),
            'hero_title'        => trim((string) $request->input('tc.hero_title', 'Professional Shop For Your Needs')),
            'hero_description'  => trim((string) $request->input('tc.hero_description', 'Fast, reliable, and affordable products and service from your trusted local shop.')),
            'primary_cta'       => trim((string) $request->input('tc.primary_cta', 'Shop Now')),
            'secondary_cta'     => trim((string) $request->input('tc.secondary_cta', 'Get Details')),
            'services_label'    => trim((string) $request->input('tc.services_label', 'Our Offerings')),
            'services_title'    => trim((string) $request->input('tc.services_title', 'Products & Services')),
            'services_subtitle' => trim((string) $request->input('tc.services_subtitle', 'Choose from our featured offerings.')),
            'why_title'         => trim((string) $request->input('tc.why_title', 'Why Choose Our Shop')),
            'why_subtitle'      => trim((string) $request->input('tc.why_subtitle', 'Quality products, fair pricing, and customer-friendly support.')),
            'cta_title'         => trim((string) $request->input('tc.cta_title', 'Visit or Contact Us Today')),
            'cta_description'   => trim((string) $request->input('tc.cta_description', 'Contact us now and get quick support.')),
            'cta_button'        => trim((string) $request->input('tc.cta_button', 'Contact Now')),
            'footer_brand'      => trim((string) $request->input('tc.footer_brand', $shop->name ?: 'My Shop')),
            'footer_tagline'    => trim((string) $request->input('tc.footer_tagline', 'Trusted · Local · Professional')),
            'provider_name'     => trim((string) $request->input('tc.provider_name', $owner->full_name ?: 'Shop Owner')),
            ...
            'provider_title'    => trim((string) $request->input('tc.provider_title', 'Founder & Lead Shop Expert')),
            'provider_bio'      => trim((string) $request->input('tc.provider_bio', 'Trusted local shop owner focused on reliable products and customer-friendly support.')),
